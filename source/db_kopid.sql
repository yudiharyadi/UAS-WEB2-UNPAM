...
CREATE TABLE `data_vaksin` (
  ...
  `faskes_type` int(11) NOT NULL,
  `faskes_name` varchar(50) NOT NULL,
...
INSERT INTO `districts` (`id`, `regency`, `name`) VALUES
...
--
-- Table structure for table `faskes_types`
--

CREATE TABLE `faskes_types` (
  `id` int(11) NOT NULL,
  `name` varchar(50) CHARACTER SET utf8mb4 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `faskes_types`
--

INSERT INTO `faskes_types` (`id`, `name`) VALUES
(1, 'RSUD'),
(2, 'RS'),
(3, 'PUSKESMAS'),
(4, 'KLINIK');
...
INSERT INTO `regencies` (`id`, `province`, `name`) VALUES
...
ALTER TABLE `data_vaksin`
  ...
  ADD KEY `faskes_type` (`faskes_type`);
...
ALTER TABLE `districts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `regency` (`regency`);

--
-- Indexes for table `faskes_types`
--
ALTER TABLE `faskes_types`
  ADD PRIMARY KEY (`id`);
...
--
-- Constraints for table `data_vaksin`
--
ALTER TABLE `data_vaksin`
  ADD CONSTRAINT `data_vaksin_ibfk_1` FOREIGN KEY (`district`) REFERENCES `districts` (`id`),
  ADD CONSTRAINT `data_vaksin_ibfk_2` FOREIGN KEY (`faskes_type`) REFERENCES `faskes_types` (`id`);

--
-- Constraints for table `districts`
--
ALTER TABLE `districts`
  ADD CONSTRAINT `districts_ibfk_1` FOREIGN KEY (`regency`) REFERENCES `regencies` (`id`);

--
-- Constraints for table `regencies`
--
ALTER TABLE `regencies`
  ADD CONSTRAINT `regencies_ibfk_1` FOREIGN KEY (`province`) REFERENCES `provinces` (`id`);
COMMIT;
